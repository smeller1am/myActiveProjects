            ...
            <img className="fish" src="./img/delivery/noCutt.png" alt=""/>
                ...
                <form className="vacancyForm">
                    <div className="vacancyForm__item">
                        <p>Имя</p>
                        <input className="vacancyForm__item-input" type="text" placeholder="Введите имя"/>
                            <p>Фамилия</p>
                            <input className="vacancyForm__item-input" type="text" placeholder="Введите фамилию"/>
                                <p>Дата рождения</p>
                                <input className="vacancyForm__item-input" type="date" placeholder="Введите дату рождения"/>
                    </div>
                    <div className="vacancyForm__item">
                        <p>Телефон</p>
                        <input name="phone" className="vacancyForm__item-input" type="tel" placeholder="+7 (___) ___-__-__"/>
                            <p>Вакансия</p>
                            ...
                            <p className="topSelect">Предыдущее место работы</p>
                            <input className="vacancyForm__item-input" type="text" placeholder="Укажите"/>
                    </div>
                </form>
                <div className="send">
