...
import { useGetContactsQuery } from '@/shared/clientApi/contactsApi';
        ...
        <div className="contactMain__info">
          <div className="contactMain__info-number">
            ...
            <div className="contactMain__info-numberBlock">
              ...
              <a href="/" className="contactMain__info-numberLink">
                +7 (8425) <span>460-460</span>
                {/*{contacts?.payload?.contacts?.phoneNumber}*/}
              </a>
          ...
          <div className="contactInfo__item">
            <div className="contactInfo__item-block">
              ...
              <div className="contactInfo__item-container">
                ...
                <a href="#" className="contactInfo__item-phone">
                  +7 (8425) <span>939-539</span>
                </a>
              </div>
            </div>
            <div className="contactInfo__item-block">
              ...
              <div className="contactInfo__item-container">
                <div className="contactInfo__item-adress">
                  ул. Мичурина, 96а
                </div>
                <a href="#" className="contactInfo__item-phone">
                  +7 (8425) <span>939-539</span>
...
export const ContactsPageWithProvider: FC = () => (
